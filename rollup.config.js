...
import { configs as smelteConfig,importMap as smelteMap } from './scripts/rollup-smelte-extract.config';
...
import { svelteExtractPlugin } from './scripts/rollup-smelte-extract.config';
...
export default [
  ...
  ...moduleConfig(),
  {
    ...
    external: [...externals, ...internals, ...modules, ...jsonFiles, 'smelte'],
    plugins: [
      ...
      production && svelteExtractPlugin(),
